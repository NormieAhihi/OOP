...
namespace Week08_AbstractClass
{
    ...
    class clsDerived : clsBase
    {
        ...
        // for the accessors.
        public override double DoubleProp
        {
            get { return (m_Double); }
        }
    ...
    class myClass: clsDerived
    {
        public myClass(double val):base(val) { }
        override public void Describe()
        {
            Console.WriteLine("Describe myClass");
        }
    }
