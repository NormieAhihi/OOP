...
namespace QLBH {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class KHACHHANGDataTable : global::System.Data.TypedTableBase<KHACHHANGRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public KHACHHANGRow AddKHACHHANGRow(string HoTen, string SoDT) {
...
namespace QLBH.DataSet1TableAdapters {
    ...
    public partial class KHACHHANGTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [KHACHHANG] WHERE (([MaKH] = @Original_MaKH) AND ([HoTen] = @Original" +
                "_HoTen) AND ([SoDT] = @Original_SoDT))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [KHACHHANG] ([HoTen], [SoDT]) VALUES (@HoTen, @SoDT);\r\nSELECT MaKH, H" +
                "oTen, SoDT FROM KHACHHANG WHERE (MaKH = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [KHACHHANG] SET [HoTen] = @HoTen, [SoDT] = @SoDT WHERE (([MaKH] = @Origina" +
                "l_MaKH) AND ([HoTen] = @Original_HoTen) AND ([SoDT] = @Original_SoDT));\r\nSELECT " +
                "MaKH, HoTen, SoDT FROM KHACHHANG WHERE (MaKH = @MaKH)";
        ...
        public virtual int Delete(int Original_MaKH, string Original_HoTen, string Original_SoDT) {
        ...
        public virtual int Insert(string HoTen, string SoDT) {
            if ((HoTen == null)) {
        ...
        public virtual int Update(string HoTen, string SoDT, int Original_MaKH, string Original_HoTen, string Original_SoDT, int MaKH) {
            if ((HoTen == null)) {
                throw new global::System.ArgumentNullException("HoTen");
            }
            else {
            ...
            if ((Original_HoTen == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Original_HoTen));
            }
            if ((Original_SoDT == null)) {
                throw new global::System.ArgumentNullException("Original_SoDT");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(Original_SoDT));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string HoTen, string SoDT, int Original_MaKH, string Original_HoTen, string Original_SoDT) {
            return this.Update(HoTen, SoDT, Original_MaKH, Original_HoTen, Original_SoDT, Original_MaKH);
        }
    }
