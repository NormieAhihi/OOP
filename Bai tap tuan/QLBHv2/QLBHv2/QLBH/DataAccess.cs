...
namespace QLBH
{
    public class DataAccess
    {
        ...
        public DataAccess() 
        {
            string strConnection = @"Data Source=.\SQLEXPRESS;Initial Catalog=QLBH;Integrated Security=True";
        ...
        public DataTable GetDataTable(string i_selectCommand)
        {
            ...
            {
                MessageBox.Show(ex.Message, "Thông báo", MessageBoxButtons.RetryCancel);
            }
            finally
            {
